...
* Edge of Antarctica; Two Differing Perspectives on Where Ice and Water Mix.ipynb `Main Jupyter Notebook Workflow`
* Edge of Antarctica; Two Differing Perspectives on Where Ice and Water Mix.html `HTML snapshot of the Jupyter Notebook`
* Blog - Edge of Antarctica; Two Differing Perspectives on Where Ice and Water Mix.ipynb `An abbreviated version of the main workflow`
* Blog - Edge of Antarctica; Two Differing Perspectives on Where Ice and Water Mix.html `HTML snapshot of the abbreviated workflow`
